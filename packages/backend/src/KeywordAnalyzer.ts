...
export class KeywordAnalyzer {
   ...
   */
  private categorizeKeyword(keyword: string): 'technical' | 'soft_skill' | 'certification' | 'tool' | 'industry' {
   ...
   */
  private getCategoryWeight(category: 'technical' | 'soft_skill' | 'certification' | 'tool' | 'industry'): number {
    const weights = {
      certification: 5,
      technical: 4,
      tool: 3,
